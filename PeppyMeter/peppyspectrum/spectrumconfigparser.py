...
FILE_CONFIG = "peppyspectrum/config.txt"
...
SPECTRUM_POS_X = "spectrum.position.x"
SPECTRUM_POS_Y = "spectrum.position.y"
SPECTRUM_WIDTH = "spectrum.width"
SPECTRUM_HEIGHT = "spectrum.height"
...
class SpectrumConfigParser(object):
    ...
    def get_config(self):
        ...
        config[SPECTRUM_POS_X] = c.getint(CURRENT, SPECTRUM_POS_X)
        config[SPECTRUM_POS_Y] = c.getint(CURRENT, SPECTRUM_POS_Y)
