...
class Spectrum(SpectrumContainer, ScreensaverSpectrum):
    ...
    def init_display(self):
        ...
        self.util.pygame_screen = self.meterutil.PYGAME_SCREEN
    ...
    def set_background(self):
        ...
        w = self.config[SPECTRUM_WIDTH]
        h = self.config[SPECTRUM_HEIGHT]
        size = c.content[1].get_size()

        spectrum_x = self.config[SPECTRUM_POS_X]
        spectrum_y = self.config[SPECTRUM_POS_Y]
